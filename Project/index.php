...
<head>
  ...
  <input class="form-field" type="text" name="username" value="Username" onfocus="this.select();" /><br />
  <div class="form-title">Password</div>
  <input class="form-field" type="password" name="password" value="Password" onfocus="this.select();"/><br /> 
...
//onclick="return confirm('Are you sure you want to log in');"
...
/*
  ...
  <input class="form-field" type="text" name="username" value="Username" onfocus="this.select();" /><br />
  <div class="form-title">Password</div>
  <input class="form-field" type="text" name="password" value="Password" onfocus="this.select();"/><br /> 
  <div class="submit-container">
  <input class="submit-button" type="submit" value="Submit" />
  </div>
  </form> 
