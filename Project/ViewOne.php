...
<tr><td>Price Expires</td><td> <input name="Pexp" value="<?php echo $tagRow['PriceExp'];?>"></td></tr>
  ...
  <div id="firstlarge"><br>Attachments<br>        
        ...
        <input type="submit" value="Upload file" formaction="add_file.php">
...
<div>
  ...
  <input type="submit" name="next" value="Next Tag">
  <input type="submit" value="Edit" formaction="edit.php"></p>
</div>
